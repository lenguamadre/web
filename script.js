...
if (waLink) waLink.href = waUrl("Hola! Quiero consultar por Lengua Madre (Programa al Vacío / Tameana). ¿Me contás cómo se trabaja, cupos y próximos pasos?");
...
function openModal(prefillKey) {
  ...
  const presets = {
    programa: "Hola! Quiero consultar por el Programa al Vacío (6 semanas). ¿Me contás cupos, próximos inicios y modalidad?",
